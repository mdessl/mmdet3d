...
def parse_args():
    ...
    parser.add_argument('--pkl_path', default="/home/markus-essl/mmdet3d/data/nuscenes/nuscenes_infos_", help='Path to the input .pkl file')
    parser.add_argument('--nusc_root', default="/home/markus-essl/mmdet3d/data/nuscenes", help='NuScenes dataset root path')
    parser.add_argument(
        '--out-path', 
        default=None,
